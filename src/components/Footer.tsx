      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              <span className="text-4xl font-bold text-white">MAQ</span>
              <span className="ml-2 text-xl font-bold text-white">Technologies</span>
            </div>
            <p className="text-gray-300 mb-6">
              MAQ Technologies provides an end-to-end platform for the creation and deployment of AI-powered smart sensor devices, giving customers 100% ownership while handling the complete technological development.
            </p>
            <p className="text-gray-300 mb-6">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.linkedin.com/company/maqtechnology/about/" 
                target="_blank" 
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} MAQ Technologies. All rights reserved.
          </p>
